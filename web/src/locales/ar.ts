  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'قم بإجراء اختبار استرجاع للتحقق مما إذا كان Агент Раггер يمكنه استرداد المحتوى المقصود لـ LLM.',
      Parse: 'تحليل',
      dataset: 'مجموعة البيانات',
      ...
      rerankTip:
        'خياري. إذا تركت فارغة، فسوف يستخدم Агент Раггер مجموعة من تشابه الكلمات الرئيسية الموزونة وتشابه جيب التمام المتجه الموزون؛ إذا تم تحديد نموذج إعادة الترتيب، فستحل درجة إعادة الترتيب المرجحة محل تشابه جيب تمام المتجه المرجح. يرجى العلم أن استخدام نموذج إعادة الترتيب سيؤدي إلى زيادة وقت استجابة النظام بشكل كبير. إذا كنت ترغب في استخدام نموذج إعادة الترتيب، فتأكد من استخدام أداة إعادة ترتيب SaaS؛ إذا كنت تفضل نموذج إعادة الترتيب المنشور محليًا، فتأكد من بدء تشغيل Агент Раггер باستخدام docker-compose-gpu.yml.',
      topK: 'توب ك',
      topKTip:
    ...
    chat: {
      ...
      betaError:
        'يرجى الحصول على مفتاح Агент Раггер API من صفحة إعدادات النظام أولاً.',
    ...
    setting: {
      ...
      embeddingModelTip:
        'نموذج التضمين الافتراضي لكل قاعدة معرفية تم إنشاؤها حديثًا. إذا لم تتمكن من العثور على نموذج التضمين من القائمة المنسدلة، فتحقق مما إذا كنت تستخدم إصدار Агент Раггер النحيف (الذي لا يتضمن نماذج التضمين) أو تحقق من https://ragflow.io/docs/dev/supported_models لمعرفة ما إذا كان موفر النموذج الخاص بك يدعم هذا النموذج.',
      img2txtModel: 'VLM',
      img2txtModelTip:
