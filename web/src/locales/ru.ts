...
[Вставьте текст здесь]`,
    ...
    admin: {
      ...
      auditPage: {
        ...
        searchPlaceholder:
          'Действие, пользователь, объект или ID цепочки',
      ...
      businessDocumentsSettingsPage: {
        description:
          'Выберите пространство EVA Wiki, с документами которого работает раздел «Документы».',
        evaSpace: 'Пространство EVA Wiki',
        evaSpacePlaceholder: 'Выберите пространство',
        evaSpacesEmpty: 'Нет настроенных пространств EVA Wiki',
        evaSpaceHelp:
          'Поиск, открытие и доработка документов EVA будут доступны только в выбранном пространстве.',
        selectedUnavailable:
          'Ранее выбранное пространство больше недоступно. Выберите другое.',
        createConnectorFirst:
          'Сначала создайте коннектор EVA Wiki и укажите в нём пространство.',
        save: 'Сохранить',
        saving: 'Сохранение...',
        saved: 'Пространство EVA Wiki для раздела «Документы» обновлено.',
      },
